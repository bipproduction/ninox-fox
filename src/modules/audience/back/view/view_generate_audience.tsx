...
import ModalGenerateAudience from "../components/modal_generate_audience";
import funCekAudienceBatch from "../fun/cek_audience_batch";

export default function ViewGenerateAudience({ param, provinsi, kabupaten, kecamatan }: { param: any, provinsi: any, kabupaten: any, kecamatan: any }) {
   ...
   async function onGenerate() {
      ...
      const cek = await funCekAudienceBatch(newScope)
      setLoading(false)
   ...
   return (
      <>
         <Stack>
            <Text fw={"bold"}>GENERATE DATA SUARA TERKUNCI</Text>
         </Stack>
         <Box pt={30}>
