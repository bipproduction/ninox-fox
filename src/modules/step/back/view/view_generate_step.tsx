...
export default function ViewGenerateStep({ param, provinsi, kabupaten, candidate }: { param: any, provinsi: any, kabupaten: any, candidate: any }) {
   ...
   return (
      <>
         <Stack>
            <Text fw={"bold"}>GENERATE DATA STEP</Text>
         </Stack>
         <Box>
