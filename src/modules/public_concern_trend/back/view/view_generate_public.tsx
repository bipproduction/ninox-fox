...
import ModalGeneratePct from "../components/modal_generate_public";
import funCekPctBatch from "../fun/cek_pct_batch";

export default function ViewGeneratePct({ param, provinsi, kabupaten, kecamatan }: { param: any, provinsi: any, kabupaten: any, kecamatan: any }) {
   ...
   async function onGenerate() {
      ...
      const cek = await funCekPctBatch(newScope)
      setLoading(false)
   ...
   return (
      <>
         <Stack>
            <Text fw={"bold"}>GENERATE DATA TREN PERHATIAN PUBLIK</Text>
         </Stack>
         <Box pt={30}>
